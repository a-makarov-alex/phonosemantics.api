...
1. НЕ УВЕРЕН В КОРРЕКТНОСТИ РАБОТЫ ПРОГРАММЫ
...
22.04.2022
ФИЧИ НА БУДУЩЕЕ
1. Ввести показатель "близости" фонем друг относительно друга.
Когда использовать: если в словах языка имеются фонемы, отсутствующие в фонемном составе этого языка, можно проверять,
какие фонемы из имеющихся наиболее им близки. Пример:
В фонетическом составе языка есть "ʈ" и "ɖ". В словах языка есть "t" и "d". Фактически, это разные фонемы,
но с высокой долей вероятности проблемы некорректных данных тут нет (например, неточно снятая транскрипция, устаревшие данные по фонемному составу и т.д.)
На основании этого показателя "близости" можно делать выводы о достоверности данных через показатель "reliability".